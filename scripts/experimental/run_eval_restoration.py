...
def main():
    ...
    parser.add_argument("--output_csv", type=str, default="./results/raw_metrics_restoration.csv")
    parser.add_argument("--methods", nargs="+", default=["bicubic"])
    ...
    print("\nSaved restoration metrics to:", args.output_csv)
    print("\nFirst 5 rows:")
    print(df.head())
